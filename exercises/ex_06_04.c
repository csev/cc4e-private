...
order each group of variable names which are identical in the first 7 characters,
but different somewhere thereafter. (Make sure that 7 is a parameter).
 */
 #include <stdio.h>
 #include <stdlib.h>
 #include <ctype.h>
 ...
 #define DEFAULT_COMP_LEN 7  /* default length to compare */
