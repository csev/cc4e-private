/*
Exercise 5-4. Rewrite appropriate programs from earlier chapters and exercises
with pointers instead of array indexing. Good possibilities include getline
(Chapter 1 and 4), atoi, itoa, and their variants (Chapter 2, 3, and Chapter 4),
reverse (Chapter 3), and index and getop (Chapter 4).
 */
 #include<stdio.h>
 #include<ctype.h>
 #include<string.h>
